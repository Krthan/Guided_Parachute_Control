...
options = optimoptions('fmincon', 'Display','iter', 'MaxFunctionEvaluations', 1e6, 'MaxIterations', 1000, 'Algorithm', 'sqp');
...
% [t, X_tm] = ode45(@(t, X) parachute_dynamics_w_inputs(t, X, tt1, U), tspan, initial_BCs(1:12), Option);
